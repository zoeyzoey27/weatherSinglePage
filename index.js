const APP_ID = '682801c47a7c3e85cd1ed1398f531d88';
const DEFAULT_VALUE = '--';
...
const handleVoice = (text) => {
    ...
    if (handledText.includes('thay đổi màu chữ')) {
        const color = handledText.split('màu chữ')[1].trim();
        container.style.color = color;
        return;
    }
    
    if (handledText.includes('màu chữ mặc định')) {
